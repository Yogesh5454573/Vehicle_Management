                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="button_su">
                                    ...
                                    <button type="button" class="hrbtns contractbtn addbttn" onclick="showModal('<?= base_url() ?>vehicles/add','Add Vehicles')"> <span class="button_text_container">
