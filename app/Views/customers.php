                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="button_su">
                                    ...
                                    <button type="button" class="hrbtns contractbtn addbttn" onclick="showModal('<?= base_url() ?>customers/add','ADD Customers')"> <span class="button_text_container">
...
buttons: [{
    ...
    function getData(){
        ...
        $.ajax({
            type:'POST',
            url:'<?= base_url()?>customers/getData',
            dataType:'json',
